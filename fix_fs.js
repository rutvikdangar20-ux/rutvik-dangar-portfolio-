...
// The original file is a mess. Let's just fix the few syntax errors dynamically!
...
content = content.replace(/key=\{idx/g, 'key={idx}');
content = content.replace(/onClick=\{\}/g, 'onClick={() => {}}');
content = content.replace(/onSubmit=\{\}/g, 'onSubmit={(e) => e.preventDefault()}');

content = content.replace(/value=\{userPrompt/g, 'value={userPrompt}');
